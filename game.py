...
def night():
  print("It is now dark outside. The guards at the end of each hallway have left their assigned location to switch shifts with the next officers. The officer that just left appears to have left behind a coat on a hook and a cane resting against your bars.\n")
  print("You look around. You find a spoon under your bed and a bar of soap on the sink. To the left and right of your cell are other inmates that you think may be able to help in your escape.")
  ...
  while choice1 not in valid_options:
    choice1=int(input("Please type 1, 2, 3, or 3."))
  while choice1!='4':
    if choice1=='1':
      dig()
    elif choice1=='2':
